...
mix.js('src/modules/app.js', 'public/js')
   ...
   .js('src/modules/ad.js', 'public/js')
   .js('src/modules/search.js', 'public/js')
   ...
   .copy('src/ad.html', 'public/ad.html')
   .copy('src/category.html', 'public/category.html')  // Pridėta nauja HTML byla
